...
const AboutUsDown = ({data}) => {
    ...
    useEffect(() => {
        setSubTitleHy(data && data.titleHy);
        setSubTitleEn(data && data.titleEn);
        setTextHy(data && data.descriptionHy)
        setTextEn(data && data.descriptionHy)
        ...
        axios
            .post(
                `${baseUrl}/aboutUs/edit`,
                {
                    titleHy: subTitleHy,
                    titleEn: subTitleEn,
                    descriptionHy: textHy, descriptionEn: textEn, image
                },
                {
                    headers: {
